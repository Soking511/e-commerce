...
categoriesRoute.route('/')
    ...
    .post(authController_1.isActive, (0, authController_1.isHaveAccess)('admin', 'manager'), authController_1.protectRoutes, categoriesController_1.uploadCategoryImage, categoriesController_1.resizeCategoryImages, categoriesValidator_1.createCategoryValidator, categoriesController_1.createCategory);
categoriesRoute.route('/:id')
    ...
    .put(authController_1.isActive, (0, authController_1.isHaveAccess)('admin', 'manager'), authController_1.protectRoutes, categoriesController_1.uploadCategoryImage, categoriesController_1.resizeCategoryImages, categoriesValidator_1.updateCategoryValidator, categoriesController_1.updateCategory);
