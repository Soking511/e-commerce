...
const getOne = (model, populateOptions) => (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!document) {
        return next(new apiErrors_1.default(('not_found'), 404));
    }
