...
// Manager [Section]
exports.getAllUsers = (0, httpMethods_1.getAll)(userModel_1.default, 'users');
...
exports.updateUser = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield userModel_1.default.findByIdAndUpdate(req.params.id, updates, { new: true });
