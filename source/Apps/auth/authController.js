...
exports.isActive = (0, express_async_handler_1.default)((req, res, next) => {
    var _a;
    return (!((_a = req.user) === null || _a === void 0 ? void 0 : _a.active)) ? next(new apiErrors_1.default('You are not active!', 403)) : next();
});
const isHaveAccess = (...Roles) => {
    return (0, express_async_handler_1.default)((req, res, next) => {
        var _a;
        if (!(Roles.includes((_a = req.user) === null || _a === void 0 ? void 0 : _a.role)))
            return next(new apiErrors_1.default('you are not allowed to access this', 403));
        next();
    });
};
