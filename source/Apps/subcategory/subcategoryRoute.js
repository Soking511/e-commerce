...
subcategoryRoute.route('/')
    ...
    .post(authController_1.isActive, (0, authController_1.isHaveAccess)('admin', 'manager'), authController_1.protectRoutes, subcategoryController_1.uploadSubcategoryImages, subcategoryController_1.resizeSubcategoryImages, subcategoriesValidator_1.createSubcategoryValidator, subcategoryController_1.createSubcategory);
subcategoryRoute.route('/:id')
    ...
    .put(authController_1.isActive, (0, authController_1.isHaveAccess)('admin', 'manager'), authController_1.protectRoutes, subcategoryController_1.uploadSubcategoryImages, subcategoryController_1.resizeSubcategoryImages, subcategoriesValidator_1.updateSubcategoryValidator, subcategoryController_1.updateSubcategory);
